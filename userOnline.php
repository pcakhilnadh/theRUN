...
<div style="float:left"></div>
 		...
 		<div id="three">
					<a href="userOnlineCoding.php"><img src="images/coding.png"></a>
					<a href="userOnlineDesign.php"><img src="images/design.png"></a>
					<a href="userOnlineQuiz.php"><img src="images/quiz.png"></a>
					</div>		
		...
		<center>
         <div style="width:600px">
           <div id="progressBar" class="jquery-ui-like"><div></div></div>
       		  <?php $check= mysql_query("SELECT * FROM `users` WHERE  `id`='".$_SESSION['uid']."' ") ; 
			    if($level = mysql_fetch_assoc($check))
				$level=$level['level'];echo intval(($level/48)*100).'% completed'; ?>
           </center>
