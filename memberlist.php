		...
		?>
			<header>
				...
				?>
				  ...
				  <h1> <b><center> POSITIONS </center></b></h1>
				</div>
...
<?php
$q=mysql_query("select * from users  ORDER BY score DESC,level DESC");
?>

<table style="font-size:15px;color:white">

<tr >
   <td style="padding-left:20px;"><b>RACER</b></td>
   <td style="padding-left:40px;"><b>Score</b></td>
   <td style="padding-left:60px;"><b>Distace Teavelled</b></td>
</tr>

<?php
while($nt=mysql_fetch_array($q)){
  $level= $nt['level']*36;
echo "<tr ><td style='padding-left:20px;'> <a href='https://www.facebook.com/$nt[username]'> $nt[name]</a></td><td style='padding-left:40px;'> $nt[score] </td><td style='padding-left:60px;'> $level km</td></tr>";
}
